...
files_list = [ "INM00042071.csv",  "INM00042273.csv",  "INM00042410.csv",  "INM00042543.csv",  "INM00042779.csv",  
               "INXUAE05784.csv",  "INXUAE05834.csv",  "INM00042101.csv",  "INM00042314.csv",  "INM00042416.csv",  
               "INM00043344.csv",  "INXUAE05454.csv",  "INXUAE05786.csv",  "INXUAE05840.csv",  "INM00042103.csv",  I
               "INM00043049.csv",  "INM00043201.csv",  "INM00043346.csv",  "INXUAE05455.csv",  "INXUAE05794.csv",  
               "INM00042867.csv",  "INM00043063.csv",  "INM00043237.csv",  "INM00043353.csv",  "INXUAE05457.csv",  
               "INM00042647.csv",  "INM00042874.csv",  "INM00043110.csv",  "INM00043284.csv",  "INM00043369.csv",  
               "INM00042516.csv",  "INM00042675.csv",  "INM00042895.csv",  "INM00043128.csv",  "INM00043285.csv", 
               "INM00042382.csv",  "INM00042539.csv",  "INM00042701.csv",  "INM00042909.csv",  "INM00043181.csv",  
               "INM00042260.csv",  "INM00042397.csv",  "INM00042542.csv",  "INM00042734.csv",  "INM00042970.csv",  
               "INXUAE05832.csv" ]
...
df= df['wdir','wspd','gph','npv','day','month','year','lvl12_1_0','lvl12_1_1','lvl12_1_2','lvl12_1_3','lvl12_2_0','lvl12_2_1']
hr = df['hour'].tolist()
ld = df['wspd'].tolist()
ld_7 = []
